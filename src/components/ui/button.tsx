  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-display",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-to-r from-primary via-secondary to-accent text-primary-foreground font-semibold hover:shadow-glow hover:scale-[1.02] border-0",
        neon: "bg-transparent border-2 border-primary text-primary hover:bg-primary/10 hover:shadow-glow relative overflow-hidden",
        pastel: "bg-accent/20 text-foreground hover:bg-accent/30 border border-accent/30",
        glass: "backdrop-blur-xl border border-border/50 bg-card/80 text-foreground hover:bg-card/90",
      },
      size: {
